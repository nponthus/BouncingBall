...
zg0=0.0002; %initial position of the center of mass
...
z(:,1)=zg0+phi0*rho.*sin(theta)-psi0*rho.*cos(theta); %initial position of the contact point supposed to be positiv
...
for nn=1:N
    ...
    [a,Ek(nn+1)]=acceleration(z(:,nn+1),rho,theta);
